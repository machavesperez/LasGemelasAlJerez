        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <form class="contact1-form validate-form" action="<?php echo base_url('Gestion/insertar_bebida_menu/'.$clave_menu['id'])?>" method="POST">
                                <div class="form-group"> 
                                     <select multiple name="tipo[]">
                                          <?php foreach ($clave_bebida as $k => $v){ ?>
                                            <option value=<?php echo($clave_bebida[$k]['id'])?>> <?php echo($clave_bebida[$k]['nombre']) ?></option>
                                        <?php } ?>
                                    </select> 
                                </div>
								...
								<div class="container-contact1-form-btn">
									...
									<a href="<?php echo base_url('Gestion/mostrar_bebidas/'.$clave_menu['id'])?>" class="btn btn-danger" role="button">Atrás</a>
								</div>
                            </form>
                        </div>
                    </div>

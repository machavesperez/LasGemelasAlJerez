        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Modificar tipo de menú <?php echo($clave['nombre']) ?>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <form class="contact1-form validate-form" action="<?php echo base_url('Gestion/cambio_tipomenu/'.$clave['id'])?>" method="POST">
                                <div class="form-group" data-validate = "Por favor, rellene el campo Nombre">
                                	<?php form_error('nombre');?>
                                    <input class="form-control" type="text" name="nombre" placeholder="Nombre del tipo de menú" value="<?php echo($clave['nombre'])?>">
                                </div>

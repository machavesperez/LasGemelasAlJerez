            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <div class="contact1-pic js-tilt" data-tilt>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <form class="contact1-form validate-form" action="<?php echo base_url('Gestion/insertar_material_evento/'.$clave_evento['id'])?>" method="POST">
                                <div class="form-group"> 
                                     <select multiple name="tipo[]">
                                          <?php foreach ($clave_material as $k => $v){ ?>
                                            <option value=<?php echo($clave_material[$k]['id'])?>> <?php echo($clave_material[$k]['nombre']) ?></option>
                                        <?php } ?>
                                    </select> 
                                </div>
                ...
                <div class="container-contact1-form-btn">
                  ...
                  <a href="<?php echo base_url('Gestion/mostrar_materiales/'.$clave_evento['id'])?>" class="btn btn-danger" role="button">Atrás</a>
                </div>
                            </form>
                        </div>
                    </div>

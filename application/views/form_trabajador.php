        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <form class="contact1-form validate-form" action="<?php echo base_url('Gestion/crear_trabajador/')?>" method="POST">
							    ...
							    <div class="form-group">Rol del trabajador:<br /> 
								    <select class="form-control" name="tipo" placeholder="Rol del trabajador"> 
								    	<?php foreach ($clave as $k => $v) { ?>
								       		<option value="<?php echo($clave[$k]['nombre']) ?>"><?php echo($clave[$k]['nombre']) ?></option>
								        <?php } ?>
								    </select>
							    </div>
